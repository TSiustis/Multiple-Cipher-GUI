...
public class Encrypt {
    ...
    public void DoDecryption() {
    	App.textArea_3.append("************************DECIPHER***********************************"+'\n');
        int start=0;
        ...
        for(int f=0; f<PlainText.length()/8; f++){
            ...
            App.textArea_3.append("*********Block Number *********"+(f+1)+'\n');
            ind=0;
            App.textArea_3.append("*********Cipher Block In Round ********* "+ Round+'\n');
            for(int d=0 ; d<8; d++){
                for(int j=0; j<8; j++){
            ...
            while(Round<=16) {
            	App.textArea_3.append("*********Round Number********* "+Round+'\n');
                for(int i=0; i<48; i++) {
                ...
                App.textArea_3.append("*********Right Part XORED with Round Key********* "+Round+'\n');
                ...
                App.textArea_3.append("*********Left Part XORED with Output Function in Round********* "+Round+'\n');
                ...
                adder=adder+48;
                Round++;
                App.textArea_3.append("*********Left=Right & Right=Left*********"+'\n');
                for(int i=0;i<32;i++) {
                    Left[i]=Right[i];
            ...
            App.textArea_3.append("********After Swap Operation********* " +'\n');
            swap32();
    ...
    public void DoEncryption(){
        ...
        for(int f=0; f<PlainText.length()/8; f++){
            ...
            App.textArea_3.append("*********Key Generation*********" +'\n');
            ...
            while(Round<=16) {
                ...
                App.textArea_3.append("*********Key For Round Number********* "+Round+'\n');
            ...
            p.FillInversePermutation();//step1 from 2D to 1D
            App.textArea_3.append("********* Inverse Permutation Operation in Round *********"+(f+1)+'\n');
            p.DoInverseIP(Block64,newBlock64);//step1 -array
